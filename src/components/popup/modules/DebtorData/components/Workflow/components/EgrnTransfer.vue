                ...
                <table>
                  ...
                  <tbody>
                      ...
                      >
                        ...
                        <td>
                          <div>
                            <span > {{ item.datestart | formatTimeStamp }} </span>
                          </div>
                        </td>
                        ...
                        <td>
                          <div>
                            <a href="javascript:void(0);" >Выгружено</a>
...
export default {
    ...
    methods: {
      ...
      initFilesInTable() {
        ...
        .catch( err => {
          ...
          .then( statusResp => {
            ...
            if (statusResp.items.rights) {
              this.files = statusResp.items.rights
            }
          })
          console.log(err)
        })
        if (this.params.AllFileDebtTransferRights) {
          this.files = this.filterDebtorFilesByExtension(Object.values(this.params.AllFileDebtTransferRights).reverse());
        } else console.log('none: Egrn transfer rights')
      },
      /**
      ...
      updateFilesInTable() {
        ...
        this.files = this.filterDebtorFilesByExtension(Object.values(debtor.AllFileDebtTransferRights).reverse());
      },
      /**
