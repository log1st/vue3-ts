<template>
    <div class="sign-in-password">
        <div class="tab-content__form">
            <div class="form-content-welcome">Восстановление пароля</div>
        <div class="login__wrapp-body">
        ...
        <div class="form-group form-btns">
            <ur-btn
                @click="validate"
                class="btn btn btn--login login-from-btn mini"
                :loading="loading"
            >
